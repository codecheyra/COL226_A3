...
- Keywords: These are words reserved for the language and cannot be used as identifiers. You would have keywords corresponding to the operations defined in class (if-then-else and operaontions  tuples).
...
Submit a single file that contains your tokeniser and test cases as comments.